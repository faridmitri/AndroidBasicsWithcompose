...
import com.fm.businesscard.ui.theme.BusinesscardTheme
...
fun BusinessCard() {
    Column(
        ...
        Text(text = stringResource(R.string.profession), color = Color.Green)
    }
    ...
    Column(
        ...
        Row(
            ...
            val icon = painterResource(id = R.drawable.ic_baseline_phone_24)
